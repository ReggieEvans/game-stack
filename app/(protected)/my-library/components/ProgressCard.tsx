...
export default function ProgressCard({
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col bg-card py-2 px-4 mb-1 border border-border rounded-md w-1/2">
  ...
  if (!hasData) {
    return (
      <div className="flex flex-col bg-card py-2 px-4 mb-1 border border-border rounded-md w-1/2 text-white justify-center items-center h-[96px]">
